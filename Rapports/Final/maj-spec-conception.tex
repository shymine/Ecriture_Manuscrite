...
\begin{center}
    ...
    \begin{tabular}{ | l | l | }
        ...
        \hline
        \rowcolor{red}PR\_TR\_1 & Intégrer une fonction de détection de lignes au logiciel \\
        \hline
        PR\_TR\_2 & Permettre un découpage des images en lignes \\
        \hline
        \rowcolor{red}PR\_TR\_3 & Localiser les paragraphes \\
        \hline
        \rowcolor{red}PR\_TR\_4 & Permettre un découpage des images en paragraphes \\
        \hline
    ...
    \begin{tabular}{ | l | l | }
        ...
        \hline
        \rowcolor{red}STO\_REC & Stocker des imagettes associées à une transcription générée par un reconnaisseur  \\
        \hline
    ...
    \begin{tabular}{ | l | l | }
        ...
        \hline
        \rowcolor{red}IR\_AP & Fournir les données au reconnaisseur \\
        \hline
    ...
    \begin{tabular}{ | l | p{0.8\linewidth} | }
        ...
        \hline
        \rowcolor{red}PEA\_GEN\_3 & Corriger les annotations proposées par un reconnaisseur externe à l'application \\
        \hline
        ...
        \rowcolor{blue}PEA\_GEN\_13 & Exporter les données d'un projet dans le format d'entrée du reconnaisseur associé au projet
        \hline
    ...
    \begin{tabular}{ | l | p{0.7\linewidth} | }
        ...
        \hline
        \rowcolor{red}LINK\_IHM\_IR & Envoyer les résultats du reconnaisseur vers le système de stockage \\
        \hline
