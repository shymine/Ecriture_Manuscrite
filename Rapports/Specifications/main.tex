...
\definecolor{pink}{rgb}{1, 0.71, 0.76}
...
\include{specifications-generales}
    
\include{preparation-bdd-interface}

\include{ihm}

% ---

\include{description-interactions}

% ---

\include{organisation-travail}
